...
## Project Structure
    ...
    ├── ideapros_llc_mosaic_31963  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_mosaic_31963`
...
2. Clone this repo and `cd ideapros_llc_mosaic_31963`
